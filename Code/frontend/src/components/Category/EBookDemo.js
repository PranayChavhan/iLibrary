              ...
              <div className="relative sm:h-52 sm:w-32 hover:h-60 hover:w-40">
                <a className="flex justify-center ">
                  <div className="h-40 w-40 bg-gradient-to-t from-black absolute -bottom-1 opacity-0 hover:opacity-100">
                    <a href={`${apiKey}${image}`} target="_blank" className="hover:bg-[#0dd6b8] bg-white rounded-sm text-black mx-2 my-3 px-8 py-2 text-[14px] hover:text-white absolute bottom-0 left-1">
                      View Book
                    </a>
                  </div>
                  <img className="bg-cover static rounded-sm" src={`${apiKey}${bookimg}`} />
